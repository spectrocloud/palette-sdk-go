...
// GetCloudAccountCloudStackByName retrieves an Apache CloudStack cloud account by name (and optional scope) using the list GET.
// scope can be "" (any), "project", or "tenant".
func (h *V1Client) GetCloudAccountCloudStackByName(name, scope string) (*models.V1CloudStackAccount, error) {
