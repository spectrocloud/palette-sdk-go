...
// ContextValidate validate this v1 pack input entity based on the context it is used
func (m *V1PackInputEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PackInputEntity) contextValidatePack(ctx context.Context, formats strfmt.Registry) error {
