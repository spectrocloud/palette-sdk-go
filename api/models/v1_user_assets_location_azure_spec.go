...
// ContextValidate validate this v1 user assets location azure spec based on the context it is used
func (m *V1UserAssetsLocationAzureSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1UserAssetsLocationAzureSpec) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
