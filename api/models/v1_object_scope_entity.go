...
// ContextValidate validates this v1 object scope entity based on context it is used
func (m *V1ObjectScopeEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
