...
// ContextValidate validates this v1 sonobuoy log based on context it is used
func (m *V1SonobuoyLog) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
