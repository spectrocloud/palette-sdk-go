...
// ContextValidate validate this v1 edge hosts meta based on the context it is used
func (m *V1EdgeHostsMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1EdgeHostsMeta) contextValidateEdgeHosts(ctx context.Context, formats strfmt.Registry) error {
