...
// V1OpenStackCloudConfigSpec OpenStackCloudConfigSpec defines the cloud configuration input by user This will translate to clusterspec/machinespec for cluster-api
//
// swagger:model v1OpenStackCloudConfigSpec
type V1OpenStackCloudConfigSpec struct {

	// cloudAccountRef should point to the secret which contains OpenStackCloudAccount
	...
	// machine pool config
	MachinePoolConfig []*V1OpenStackMachinePoolConfig `json:"machinePoolConfig"`
}

// Validate validates this v1 open stack cloud config spec
func (m *V1OpenStackCloudConfigSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OpenStackCloudConfigSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OpenStackCloudConfigSpec) UnmarshalBinary(b []byte) error {
	var res V1OpenStackCloudConfigSpec
