...
// V1WorkspaceClusterWorkloadStatefulSets Workspace cluster workload statefulsets summary
//
// swagger:model v1WorkspaceClusterWorkloadStatefulSets
type V1WorkspaceClusterWorkloadStatefulSets struct {
...
// Validate validates this v1 workspace cluster workload stateful sets
func (m *V1WorkspaceClusterWorkloadStatefulSets) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspaceClusterWorkloadStatefulSets) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1WorkspaceClusterWorkloadStatefulSets) UnmarshalBinary(b []byte) error {
	var res V1WorkspaceClusterWorkloadStatefulSets
