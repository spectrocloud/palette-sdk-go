...
// ContextValidate validate this v1 workspace clusters workload stateful sets based on the context it is used
func (m *V1WorkspaceClustersWorkloadStatefulSets) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspaceClustersWorkloadStatefulSets) contextValidateClusters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1WorkspaceClustersWorkloadStatefulSets) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
