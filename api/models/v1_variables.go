...
// ContextValidate validate this v1 variables based on the context it is used
func (m *V1Variables) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1Variables) contextValidateVariables(ctx context.Context, formats strfmt.Registry) error {
