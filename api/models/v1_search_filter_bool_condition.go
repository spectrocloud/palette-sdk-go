...
// ContextValidate validates this v1 search filter bool condition based on context it is used
func (m *V1SearchFilterBoolCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
