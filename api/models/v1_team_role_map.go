...
// ContextValidate validates this v1 team role map based on context it is used
func (m *V1TeamRoleMap) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
