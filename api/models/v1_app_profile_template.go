...
// ContextValidate validate this v1 app profile template based on the context it is used
func (m *V1AppProfileTemplate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AppProfileTemplate) contextValidateAppTiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AppProfileTemplate) contextValidateRegistryRefs(ctx context.Context, formats strfmt.Registry) error {
