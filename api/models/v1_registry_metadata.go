...
// ContextValidate validates this v1 registry metadata based on context it is used
func (m *V1RegistryMetadata) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
