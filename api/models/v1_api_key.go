...
type V1APIKey struct {
	...
	// spec
	Spec *V1APIKeySpec `json:"spec,omitempty"`
...
func (m *V1APIKey) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1APIKey) validateSpec(formats strfmt.Registry) error {
...
func (m *V1APIKey) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1APIKey) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
