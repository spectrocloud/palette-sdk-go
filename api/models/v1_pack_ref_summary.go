...
// ContextValidate validate this v1 pack ref summary based on the context it is used
func (m *V1PackRefSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PackRefSummary) contextValidateLayer(ctx context.Context, formats strfmt.Registry) error {
