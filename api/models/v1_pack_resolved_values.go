...
// ContextValidate validates this v1 pack resolved values based on context it is used
func (m *V1PackResolvedValues) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
