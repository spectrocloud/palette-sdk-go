...
// ContextValidate validate this v1 edge host device meta update entity based on the context it is used
func (m *V1EdgeHostDeviceMetaUpdateEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1EdgeHostDeviceMetaUpdateEntity) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
