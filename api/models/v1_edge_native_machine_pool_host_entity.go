...
func (m *V1EdgeNativeMachinePoolHostEntity) validateTaints(formats strfmt.Registry) error {
...
func (m *V1EdgeNativeMachinePoolHostEntity) contextValidateTaints(ctx context.Context, formats strfmt.Registry) error {
