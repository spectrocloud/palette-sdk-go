...
// ContextValidate validates this v1 bulk delete failure based on context it is used
func (m *V1BulkDeleteFailure) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
