...
// ContextValidate validates this v1 edge host spec host based on context it is used
func (m *V1EdgeHostSpecHost) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
