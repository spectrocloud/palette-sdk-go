...
// ContextValidate validate this v1 service manifest based on the context it is used
func (m *V1ServiceManifest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ServiceManifest) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ServiceManifest) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
