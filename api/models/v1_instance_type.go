...
// ContextValidate validate this v1 instance type based on the context it is used
func (m *V1InstanceType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1InstanceType) contextValidateCost(ctx context.Context, formats strfmt.Registry) error {
