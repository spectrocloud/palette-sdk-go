...
// ContextValidate validates this v1 zone entity based on context it is used
func (m *V1ZoneEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
