...
// ContextValidate validate this v1 packs filter spec based on the context it is used
func (m *V1PacksFilterSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PacksFilterSpec) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PacksFilterSpec) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
