...
// ContextValidate validate this v1 total resource usage based on the context it is used
func (m *V1TotalResourceUsage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1TotalResourceUsage) contextValidateProjects(ctx context.Context, formats strfmt.Registry) error {
