...
// ContextValidate validates this v1 Vm resource requirements based on context it is used
func (m *V1VMResourceRequirements) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
