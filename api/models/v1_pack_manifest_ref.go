...
// ContextValidate validates this v1 pack manifest ref based on context it is used
func (m *V1PackManifestRef) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
