...
// V1OverloadStatus Overload status
//
// swagger:model v1OverloadStatus
type V1OverloadStatus struct {
...
// Validate validates this v1 overload status
func (m *V1OverloadStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OverloadStatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OverloadStatus) UnmarshalBinary(b []byte) error {
	var res V1OverloadStatus
