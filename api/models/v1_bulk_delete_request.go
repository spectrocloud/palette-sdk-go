...
// ContextValidate validates this v1 bulk delete request based on context it is used
func (m *V1BulkDeleteRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
