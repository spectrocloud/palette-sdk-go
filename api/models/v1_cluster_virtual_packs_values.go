...
// ContextValidate validate this v1 cluster virtual packs values based on the context it is used
func (m *V1ClusterVirtualPacksValues) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterVirtualPacksValues) contextValidatePacks(ctx context.Context, formats strfmt.Registry) error {
