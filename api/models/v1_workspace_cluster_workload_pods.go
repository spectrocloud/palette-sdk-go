...
// ContextValidate validate this v1 workspace cluster workload pods based on the context it is used
func (m *V1WorkspaceClusterWorkloadPods) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspaceClusterWorkloadPods) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1WorkspaceClusterWorkloadPods) contextValidatePods(ctx context.Context, formats strfmt.Registry) error {
