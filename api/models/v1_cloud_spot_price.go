...
// ContextValidate validates this v1 cloud spot price based on context it is used
func (m *V1CloudSpotPrice) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
