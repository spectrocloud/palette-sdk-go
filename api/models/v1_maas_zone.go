...
// ContextValidate validates this v1 maas zone based on context it is used
func (m *V1MaasZone) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
