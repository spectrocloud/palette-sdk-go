...
// ContextValidate validate this v1 oci registry entity based on the context it is used
func (m *V1OciRegistryEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OciRegistryEntity) contextValidateAuth(ctx context.Context, formats strfmt.Registry) error {
