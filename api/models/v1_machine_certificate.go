...
// ContextValidate validate this v1 machine certificate based on the context it is used
func (m *V1MachineCertificate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1MachineCertificate) contextValidateCertificateAuthorities(ctx context.Context, formats strfmt.Registry) error {
