...
// ContextValidate validate this v1 cluster search input spec based on the context it is used
func (m *V1ClusterSearchInputSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterSearchInputSpec) contextValidateInputs(ctx context.Context, formats strfmt.Registry) error {
