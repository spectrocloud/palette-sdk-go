...
// ContextValidate validates this v1 Vm input based on context it is used
func (m *V1VMInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
