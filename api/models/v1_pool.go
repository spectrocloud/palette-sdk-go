...
// ContextValidate validate this v1 pool based on the context it is used
func (m *V1Pool) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1Pool) contextValidateNameserver(ctx context.Context, formats strfmt.Registry) error {
