...
// ContextValidate validate this v1 vsphere placement config entity based on the context it is used
func (m *V1VspherePlacementConfigEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VspherePlacementConfigEntity) contextValidateNetwork(ctx context.Context, formats strfmt.Registry) error {
