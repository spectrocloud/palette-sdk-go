...
// ContextValidate validates this v1 variable names based on context it is used
func (m *V1VariableNames) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
