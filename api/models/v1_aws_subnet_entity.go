...
// ContextValidate validates this v1 aws subnet entity based on context it is used
func (m *V1AwsSubnetEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
