	...
	if m.SSHSecret != nil {
		if err := m.SSHSecret.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("sshSecret")
			}
			return err
		}
	}
...
// ContextValidate validate this v1 edge host identity based on the context it is used
func (m *V1EdgeHostIdentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateSSHSecret(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1EdgeHostIdentity) contextValidateSSHSecret(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.SSHSecret != nil {
		...
		if err := m.SSHSecret.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sshSecret")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sshSecret")
