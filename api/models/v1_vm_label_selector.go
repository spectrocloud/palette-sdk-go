...
// ContextValidate validate this v1 Vm label selector based on the context it is used
func (m *V1VMLabelSelector) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VMLabelSelector) contextValidateMatchExpressions(ctx context.Context, formats strfmt.Registry) error {
