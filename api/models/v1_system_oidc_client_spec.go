...
// ContextValidate validate this v1 system oidc client spec based on the context it is used
func (m *V1SystemOidcClientSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SystemOidcClientSpec) contextValidateRequiredClaims(ctx context.Context, formats strfmt.Registry) error {
