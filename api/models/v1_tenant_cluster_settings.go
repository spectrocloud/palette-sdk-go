...
// ContextValidate validate this v1 tenant cluster settings based on the context it is used
func (m *V1TenantClusterSettings) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1TenantClusterSettings) contextValidateNodesAutoRemediationSetting(ctx context.Context, formats strfmt.Registry) error {
