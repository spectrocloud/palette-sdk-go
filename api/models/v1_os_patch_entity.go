...
// ContextValidate validate this v1 os patch entity based on the context it is used
func (m *V1OsPatchEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OsPatchEntity) contextValidateOsPatchConfig(ctx context.Context, formats strfmt.Registry) error {
