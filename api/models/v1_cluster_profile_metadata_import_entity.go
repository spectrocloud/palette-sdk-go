...
// ContextValidate validates this v1 cluster profile metadata import entity based on context it is used
func (m *V1ClusterProfileMetadataImportEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
