...
// ContextValidate validates this v1 vsphere instance type based on context it is used
func (m *V1VsphereInstanceType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
