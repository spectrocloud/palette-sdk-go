...
// ContextValidate validate this v1 aws secret spec based on the context it is used
func (m *V1AwsSecretSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsSecretSpec) contextValidateTLS(ctx context.Context, formats strfmt.Registry) error {
