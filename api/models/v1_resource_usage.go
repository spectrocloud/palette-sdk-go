...
// ContextValidate validate this v1 resource usage based on the context it is used
func (m *V1ResourceUsage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ResourceUsage) contextValidateProjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ResourceUsage) contextValidateTimestamp(ctx context.Context, formats strfmt.Registry) error {
