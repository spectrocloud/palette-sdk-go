...
// ContextValidate validate this v1 hybrid machine pool based on the context it is used
func (m *V1HybridMachinePool) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1HybridMachinePool) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
