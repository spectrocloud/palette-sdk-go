...
// ContextValidate validates this v1 kube bench log entity based on context it is used
func (m *V1KubeBenchLogEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
