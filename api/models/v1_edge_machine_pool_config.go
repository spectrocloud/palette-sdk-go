...
// V1EdgeMachinePoolConfig v1 edge machine pool config
//
// swagger:model v1EdgeMachinePoolConfig
type V1EdgeMachinePoolConfig struct {
	...
	// hosts
	// Required: true
	Hosts []*V1EdgeMachinePoolHost `json:"hosts"`
...
// Validate validates this v1 edge machine pool config
func (m *V1EdgeMachinePoolConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1EdgeMachinePoolConfig) validateHosts(formats strfmt.Registry) error {
...
func (m *V1EdgeMachinePoolConfig) validateMachinePoolProperties(formats strfmt.Registry) error {
...
func (m *V1EdgeMachinePoolConfig) validateTaints(formats strfmt.Registry) error {
...
func (m *V1EdgeMachinePoolConfig) validateUpdateStrategy(formats strfmt.Registry) error {
...
func (m *V1EdgeMachinePoolConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1EdgeMachinePoolConfig) UnmarshalBinary(b []byte) error {
	var res V1EdgeMachinePoolConfig
