...
// ContextValidate validate this v1 workspace cluster restore response based on the context it is used
func (m *V1WorkspaceClusterRestoreResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspaceClusterRestoreResponse) contextValidateRestoreStatusMeta(ctx context.Context, formats strfmt.Registry) error {
