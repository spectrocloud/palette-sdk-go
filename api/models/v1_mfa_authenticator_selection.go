...
// ContextValidate validates this v1 mfa authenticator selection based on context it is used
func (m *V1MfaAuthenticatorSelection) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
