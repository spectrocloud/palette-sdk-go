...
//
// swagger:model v1EdgeNativeMachinePoolConfigEntity
...
func (m *V1EdgeNativeMachinePoolConfigEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
// ContextValidate validate this v1 edge native machine pool config entity based on the context it is used
func (m *V1EdgeNativeMachinePoolConfigEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1EdgeNativeMachinePoolConfigEntity) contextValidateCloudConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1EdgeNativeMachinePoolConfigEntity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1EdgeNativeMachinePoolConfigEntity) UnmarshalBinary(b []byte) error {
	var res V1EdgeNativeMachinePoolConfigEntity
