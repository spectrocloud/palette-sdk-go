...
// V1TencentMachinePoolConfig v1 tencent machine pool config
//
// swagger:model v1TencentMachinePoolConfig
type V1TencentMachinePoolConfig struct {
...
// Validate validates this v1 tencent machine pool config
func (m *V1TencentMachinePoolConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1TencentMachinePoolConfig) validateInstanceConfig(formats strfmt.Registry) error {
...
func (m *V1TencentMachinePoolConfig) validateMachinePoolProperties(formats strfmt.Registry) error {
...
func (m *V1TencentMachinePoolConfig) validateTaints(formats strfmt.Registry) error {
...
func (m *V1TencentMachinePoolConfig) validateUpdateStrategy(formats strfmt.Registry) error {
...
func (m *V1TencentMachinePoolConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1TencentMachinePoolConfig) UnmarshalBinary(b []byte) error {
	var res V1TencentMachinePoolConfig
