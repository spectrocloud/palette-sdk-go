...
// V1OverlordOpenStackCloudConfig v1 overlord open stack cloud config
//
// swagger:model v1OverlordOpenStackCloudConfig
type V1OverlordOpenStackCloudConfig struct {
	...
	// machine config
	MachineConfig *V1OpenStackMachineConfigEntity `json:"machineConfig,omitempty"`

	// size of the pool, number of machines
	Size int32 `json:"size,omitempty"`
}

// Validate validates this v1 overlord open stack cloud config
func (m *V1OverlordOpenStackCloudConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OverlordOpenStackCloudConfig) validateClusterConfig(formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) validateClusterProfiles(formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) validateClusterSettings(formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) validateMachineConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 overlord open stack cloud config based on the context it is used
func (m *V1OverlordOpenStackCloudConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OverlordOpenStackCloudConfig) contextValidateClusterConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) contextValidateClusterProfiles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) contextValidateClusterSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) contextValidateMachineConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OverlordOpenStackCloudConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OverlordOpenStackCloudConfig) UnmarshalBinary(b []byte) error {
	var res V1OverlordOpenStackCloudConfig
