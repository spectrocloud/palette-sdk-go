...
func NewV1MfaConveyancePreference(value V1MfaConveyancePreference) *V1MfaConveyancePreference {
	return &value
}

// Pointer returns a pointer to a freshly-allocated V1MfaConveyancePreference.
func (m V1MfaConveyancePreference) Pointer() *V1MfaConveyancePreference {
	return &m
}
...
// ContextValidate validates this v1 mfa conveyance preference based on context it is used
func (m V1MfaConveyancePreference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
