...
// ContextValidate validate this v1 cluster workload pod container resources based on the context it is used
func (m *V1ClusterWorkloadPodContainerResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterWorkloadPodContainerResources) contextValidateLimits(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterWorkloadPodContainerResources) contextValidateRequests(ctx context.Context, formats strfmt.Registry) error {
