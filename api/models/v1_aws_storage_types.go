...
// ContextValidate validate this v1 aws storage types based on the context it is used
func (m *V1AwsStorageTypes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsStorageTypes) contextValidateStorageTypes(ctx context.Context, formats strfmt.Registry) error {
