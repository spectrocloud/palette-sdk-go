...
// ContextValidate validate this v1 workspaces roles based on the context it is used
func (m *V1WorkspacesRoles) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspacesRoles) contextValidateInheritedRoles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1WorkspacesRoles) contextValidateRoles(ctx context.Context, formats strfmt.Registry) error {
