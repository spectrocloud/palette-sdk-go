...
// V1ProjectSpec Project specifications
//
// swagger:model v1ProjectSpec
type V1ProjectSpec struct {

	// alerts
	// Unique: true
	Alerts []*V1Alert `json:"alerts"`
...
// Validate validates this v1 project spec
func (m *V1ProjectSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ProjectSpec) validateAlerts(formats strfmt.Registry) error {
	...
	if err := validate.UniqueItems("alerts", "body", m.Alerts); err != nil {
		return err
	}
...
func (m *V1ProjectSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ProjectSpec) UnmarshalBinary(b []byte) error {
	var res V1ProjectSpec
