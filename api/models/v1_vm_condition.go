...
// ContextValidate validates this v1 Vm condition based on context it is used
func (m *V1VMCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
