...
// ContextValidate validate this v1 maas cloud cluster config entity based on the context it is used
func (m *V1MaasCloudClusterConfigEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1MaasCloudClusterConfigEntity) contextValidateClusterConfig(ctx context.Context, formats strfmt.Registry) error {
