...
// V1ClusterWorkloadNamespaces Cluster workload namespaces summary
//
// swagger:model v1ClusterWorkloadNamespaces
type V1ClusterWorkloadNamespaces struct {

	// namespaces
	Namespaces []*V1ClusterWorkloadNamespace `json:"namespaces"`
}

// Validate validates this v1 cluster workload namespaces
func (m *V1ClusterWorkloadNamespaces) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterWorkloadNamespaces) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ClusterWorkloadNamespaces) UnmarshalBinary(b []byte) error {
	var res V1ClusterWorkloadNamespaces
