...
// ContextValidate validates this v1 eks addon based on context it is used
func (m *V1EksAddon) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
