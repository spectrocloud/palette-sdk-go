...
// ContextValidate validate this v1 spectro cluster profiles based on the context it is used
func (m *V1SpectroClusterProfiles) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SpectroClusterProfiles) contextValidateProfiles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SpectroClusterProfiles) contextValidateSpcApplySettings(ctx context.Context, formats strfmt.Registry) error {
