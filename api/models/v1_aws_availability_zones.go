...
// ContextValidate validate this v1 aws availability zones based on the context it is used
func (m *V1AwsAvailabilityZones) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsAvailabilityZones) contextValidateZones(ctx context.Context, formats strfmt.Registry) error {
