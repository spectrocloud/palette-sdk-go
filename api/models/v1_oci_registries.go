...
// ContextValidate validate this v1 oci registries based on the context it is used
func (m *V1OciRegistries) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OciRegistries) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
