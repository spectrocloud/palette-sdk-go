...
// ContextValidate validates this v1 Vm owner reference based on context it is used
func (m *V1VMOwnerReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
