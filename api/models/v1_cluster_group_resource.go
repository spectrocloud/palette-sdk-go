...
// ContextValidate validates this v1 cluster group resource based on context it is used
func (m *V1ClusterGroupResource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
