...
// ContextValidate validate this v1 pack template parameters based on the context it is used
func (m *V1PackTemplateParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PackTemplateParameters) contextValidateInputParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PackTemplateParameters) contextValidateOutputParameters(ctx context.Context, formats strfmt.Registry) error {
