...
// V1UserSummarySortSpec v1 user summary sort spec
//
// swagger:model v1UserSummarySortSpec
type V1UserSummarySortSpec struct {
...
func (m *V1UserSummarySortSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1UserSummarySortSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1UserSummarySortSpec) UnmarshalBinary(b []byte) error {
	var res V1UserSummarySortSpec
