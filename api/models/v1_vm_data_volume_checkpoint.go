...
// ContextValidate validates this v1 Vm data volume checkpoint based on context it is used
func (m *V1VMDataVolumeCheckpoint) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
