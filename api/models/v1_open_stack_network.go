...
// ContextValidate validate this v1 open stack network based on the context it is used
func (m *V1OpenStackNetwork) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OpenStackNetwork) contextValidateSubnets(ctx context.Context, formats strfmt.Registry) error {
