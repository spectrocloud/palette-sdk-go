...
// ContextValidate validate this v1 aws policies based on the context it is used
func (m *V1AwsPolicies) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsPolicies) contextValidatePolicies(ctx context.Context, formats strfmt.Registry) error {
