...
// ContextValidate validates this v1 eks properties validate spec based on context it is used
func (m *V1EksPropertiesValidateSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
