...
// ContextValidate validate this v1 kube hunter entity based on the context it is used
func (m *V1KubeHunterEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1KubeHunterEntity) contextValidateReports(ctx context.Context, formats strfmt.Registry) error {
