...
// ContextValidate validates this v1 Vm data volume source Http based on context it is used
func (m *V1VMDataVolumeSourceHTTP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
