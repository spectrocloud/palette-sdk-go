...
// ContextValidate validate this v1 spectro vsphere cluster rate entity based on the context it is used
func (m *V1SpectroVsphereClusterRateEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SpectroVsphereClusterRateEntity) contextValidateCloudConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SpectroVsphereClusterRateEntity) contextValidateMachinepoolconfig(ctx context.Context, formats strfmt.Registry) error {
