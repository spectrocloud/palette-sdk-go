...
// ContextValidate validate this v1 aws instance types based on the context it is used
func (m *V1AwsInstanceTypes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsInstanceTypes) contextValidateInstanceTypes(ctx context.Context, formats strfmt.Registry) error {
