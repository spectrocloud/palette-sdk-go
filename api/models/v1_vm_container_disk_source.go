...
// ContextValidate validates this v1 Vm container disk source based on context it is used
func (m *V1VMContainerDiskSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
