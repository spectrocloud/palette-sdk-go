...
// ContextValidate validate this v1 cluster refs based on the context it is used
func (m *V1ClusterRefs) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterRefs) contextValidateClusters(ctx context.Context, formats strfmt.Registry) error {
