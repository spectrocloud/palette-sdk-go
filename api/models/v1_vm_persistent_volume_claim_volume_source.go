...
// ContextValidate validates this v1 Vm persistent volume claim volume source based on context it is used
func (m *V1VMPersistentVolumeClaimVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
