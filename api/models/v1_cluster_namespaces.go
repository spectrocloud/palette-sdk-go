...
// ContextValidate validate this v1 cluster namespaces based on the context it is used
func (m *V1ClusterNamespaces) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterNamespaces) contextValidateNamespaces(ctx context.Context, formats strfmt.Registry) error {
