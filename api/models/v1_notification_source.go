...
// ContextValidate validates this v1 notification source based on context it is used
func (m *V1NotificationSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
