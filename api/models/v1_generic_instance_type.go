...
// ContextValidate validates this v1 generic instance type based on context it is used
func (m *V1GenericInstanceType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
