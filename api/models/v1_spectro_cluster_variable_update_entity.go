...
// ContextValidate validate this v1 spectro cluster variable update entity based on the context it is used
func (m *V1SpectroClusterVariableUpdateEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SpectroClusterVariableUpdateEntity) contextValidateVariables(ctx context.Context, formats strfmt.Registry) error {
