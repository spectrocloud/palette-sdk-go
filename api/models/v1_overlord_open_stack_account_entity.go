...
// ContextValidate validate this v1 overlord open stack account entity based on the context it is used
func (m *V1OverlordOpenStackAccountEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OverlordOpenStackAccountEntity) contextValidateAccount(ctx context.Context, formats strfmt.Registry) error {
