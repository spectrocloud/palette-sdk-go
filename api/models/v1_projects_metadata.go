...
// ContextValidate validate this v1 projects metadata based on the context it is used
func (m *V1ProjectsMetadata) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ProjectsMetadata) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
