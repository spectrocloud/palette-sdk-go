...
// ContextValidate validates this v1 developer credit based on context it is used
func (m *V1DeveloperCredit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
