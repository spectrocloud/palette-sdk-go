...
// ContextValidate validates this v1 azure image based on context it is used
func (m *V1AzureImage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
