...
// ContextValidate validates this v1 theme metadata based on context it is used
func (m *V1ThemeMetadata) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
