...
// ContextValidate validate this v1 cluster profile status based on the context it is used
...
func (m *V1ClusterProfileStatus) contextValidateInUseClusters(ctx context.Context, formats strfmt.Registry) error {
