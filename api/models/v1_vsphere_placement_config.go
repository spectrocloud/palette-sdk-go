...
type V1VspherePlacementConfig struct {
	...
	// network info
	Network *V1VsphereNetworkConfig `json:"network,omitempty"`
...
// Validate validates this v1 vsphere placement config
func (m *V1VspherePlacementConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1VspherePlacementConfig) validateNetwork(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 vsphere placement config based on the context it is used
func (m *V1VspherePlacementConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VspherePlacementConfig) contextValidateNetwork(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1VspherePlacementConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1VspherePlacementConfig) UnmarshalBinary(b []byte) error {
	var res V1VspherePlacementConfig
