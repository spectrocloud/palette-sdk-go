...
// ContextValidate validate this v1 spectro generic cluster rate entity based on the context it is used
func (m *V1SpectroGenericClusterRateEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SpectroGenericClusterRateEntity) contextValidateCloudConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SpectroGenericClusterRateEntity) contextValidateMachinepoolconfig(ctx context.Context, formats strfmt.Registry) error {
