...
// ContextValidate validate this v1 project status based on the context it is used
func (m *V1ProjectStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ProjectStatus) contextValidateCleanUpStatus(ctx context.Context, formats strfmt.Registry) error {
