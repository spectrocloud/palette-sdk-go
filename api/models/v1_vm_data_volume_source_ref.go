...
// ContextValidate validates this v1 Vm data volume source ref based on context it is used
func (m *V1VMDataVolumeSourceRef) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
