...
// ContextValidate validate this v1 search filter string condition based on the context it is used
func (m *V1SearchFilterStringCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SearchFilterStringCondition) contextValidateMatch(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SearchFilterStringCondition) contextValidateOperator(ctx context.Context, formats strfmt.Registry) error {
