	...
	if m.QemuGuestAgent != nil {
		if err := m.QemuGuestAgent.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("qemuGuestAgent")
			}
			return err
		}
	}
...
// ContextValidate validate this v1 Vm Ssh public key access credential propagation method based on the context it is used
func (m *V1VMSSHPublicKeyAccessCredentialPropagationMethod) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateQemuGuestAgent(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1VMSSHPublicKeyAccessCredentialPropagationMethod) contextValidateQemuGuestAgent(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.QemuGuestAgent != nil {
		...
		if err := m.QemuGuestAgent.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("qemuGuestAgent")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("qemuGuestAgent")
