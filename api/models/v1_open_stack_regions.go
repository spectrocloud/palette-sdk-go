...
// ContextValidate validate this v1 open stack regions based on the context it is used
func (m *V1OpenStackRegions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1OpenStackRegions) contextValidateDomains(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OpenStackRegions) contextValidateRegions(ctx context.Context, formats strfmt.Registry) error {
