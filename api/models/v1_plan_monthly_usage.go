		...
		if m.DailyUsages[i] != nil {
			if err := m.DailyUsages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("dailyUsages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.TotalMonthlyUsage != nil {
		if err := m.TotalMonthlyUsage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("totalMonthlyUsage")
			}
			return err
		}
	}
...
// ContextValidate validate this v1 plan monthly usage based on the context it is used
func (m *V1PlanMonthlyUsage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateDailyUsages(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateTotalMonthlyUsage(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1PlanMonthlyUsage) contextValidateDailyUsages(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.DailyUsages); i++ {
		...
		if m.DailyUsages[i] != nil {
			...
			if err := m.DailyUsages[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("dailyUsages" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("dailyUsages" + "." + strconv.Itoa(i))
...
func (m *V1PlanMonthlyUsage) contextValidateMonth(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PlanMonthlyUsage) contextValidatePlanLimit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PlanMonthlyUsage) contextValidateTotalMonthlyUsage(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TotalMonthlyUsage != nil {
		...
		if err := m.TotalMonthlyUsage.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("totalMonthlyUsage")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("totalMonthlyUsage")
