...
// V1VMObjectMeta ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
//
// swagger:model v1VmObjectMeta
type V1VMObjectMeta struct {
	...
	ManagedFields []*V1VMManagedFieldsEntry `json:"managedFields"`
	...
	OwnerReferences []*V1VMOwnerReference `json:"ownerReferences"`
...
// Validate validates this v1 Vm object meta
func (m *V1VMObjectMeta) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1VMObjectMeta) validateDeletionTimestamp(formats strfmt.Registry) error {
...
func (m *V1VMObjectMeta) validateManagedFields(formats strfmt.Registry) error {
...
func (m *V1VMObjectMeta) validateOwnerReferences(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 Vm object meta based on the context it is used
func (m *V1VMObjectMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VMObjectMeta) contextValidateManagedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1VMObjectMeta) contextValidateOwnerReferences(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1VMObjectMeta) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1VMObjectMeta) UnmarshalBinary(b []byte) error {
	var res V1VMObjectMeta
