...
// ContextValidate validates this v1 edge token status based on context it is used
func (m *V1EdgeTokenStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
