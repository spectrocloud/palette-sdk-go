...
// ContextValidate validate this v1 service manifest spec based on the context it is used
func (m *V1ServiceManifestSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ServiceManifestSpec) contextValidateManifests(ctx context.Context, formats strfmt.Registry) error {
