...
// ContextValidate validate this v1 pack template based on the context it is used
func (m *V1PackTemplate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PackTemplate) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
