...
// ContextValidate validate this v1 Vm pod Dns config based on the context it is used
func (m *V1VMPodDNSConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VMPodDNSConfig) contextValidateOptions(ctx context.Context, formats strfmt.Registry) error {
