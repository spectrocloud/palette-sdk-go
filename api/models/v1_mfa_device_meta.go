...
// ContextValidate validate this v1 mfa device meta based on the context it is used
func (m *V1MfaDeviceMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1MfaDeviceMeta) contextValidateCreationTimestamp(ctx context.Context, formats strfmt.Registry) error {
