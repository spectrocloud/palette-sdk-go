...
// ContextValidate validates this v1 spectro cluster VM clone entity based on context it is used
func (m *V1SpectroClusterVMCloneEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
