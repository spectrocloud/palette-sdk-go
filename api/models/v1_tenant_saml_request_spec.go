...
// ContextValidate validate this v1 tenant saml request spec based on the context it is used
func (m *V1TenantSamlRequestSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1TenantSamlRequestSpec) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
