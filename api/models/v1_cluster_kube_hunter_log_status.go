...
// ContextValidate validate this v1 cluster kube hunter log status based on the context it is used
func (m *V1ClusterKubeHunterLogStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ClusterKubeHunterLogStatus) contextValidateActor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterKubeHunterLogStatus) contextValidateReports(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ClusterKubeHunterLogStatus) contextValidateScanTime(ctx context.Context, formats strfmt.Registry) error {
