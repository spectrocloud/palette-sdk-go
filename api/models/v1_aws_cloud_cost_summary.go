...
// ContextValidate validate this v1 aws cloud cost summary based on the context it is used
func (m *V1AwsCloudCostSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsCloudCostSummary) contextValidateCost(ctx context.Context, formats strfmt.Registry) error {
