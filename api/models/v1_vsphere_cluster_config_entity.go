...
// V1VsphereClusterConfigEntity v1 vsphere cluster config entity
//
// swagger:model v1VsphereClusterConfigEntity
type V1VsphereClusterConfigEntity struct {
...
// Validate validates this v1 vsphere cluster config entity
func (m *V1VsphereClusterConfigEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1VsphereClusterConfigEntity) validatePlacement(formats strfmt.Registry) error {
...
func (m *V1VsphereClusterConfigEntity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1VsphereClusterConfigEntity) UnmarshalBinary(b []byte) error {
	var res V1VsphereClusterConfigEntity
