...
// V1AwsCloudConfigSpec AwsCloudConfigSpec defines the cloud configuration input by user This will translate to clusterspec/machinespec for cluster-api
//
// swagger:model v1AwsCloudConfigSpec
type V1AwsCloudConfigSpec struct {

	// cloudAccountRef should point to the secret which contains AwsCloudAccount
...
// Validate validates this v1 aws cloud config spec
func (m *V1AwsCloudConfigSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsCloudConfigSpec) validateCloudAccountRef(formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) validateClusterConfig(formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) validateMachinePoolConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 aws cloud config spec based on the context it is used
func (m *V1AwsCloudConfigSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AwsCloudConfigSpec) contextValidateCloudAccountRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) contextValidateClusterConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) contextValidateHybridMachinePools(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) contextValidateMachinePoolConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AwsCloudConfigSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1AwsCloudConfigSpec) UnmarshalBinary(b []byte) error {
	var res V1AwsCloudConfigSpec
