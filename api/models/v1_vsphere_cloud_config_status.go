...
// ContextValidate validate this v1 vsphere cloud config status based on the context it is used
func (m *V1VsphereCloudConfigStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1VsphereCloudConfigStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1VsphereCloudConfigStatus) contextValidateNodeImage(ctx context.Context, formats strfmt.Registry) error {
